package com.yefeng.readingcloud.account.common.config;
 ...
 */
@Configuration
@MapperScan(basePackages = "com.yefeng.readingcloud.account.dao",
...
//                    .select()
//                    .apis(RequestHandlerSelectors.basePackage("com.yefeng.readingcloud.account.controller"))
